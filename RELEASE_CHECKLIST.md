...
- [ ] Check `/`, `/recommendations/`, `/thesis/`, `/monero/`, `/plasma/`, `/aave/`, `/go/plasma-one/`, `/docs/`, `/projects/`, `/projects/gmcp/`, `/labs/`, `/labs/dsx-air/`, `/infrastructure/`, `/contact/`, and `security.txt`, including the Fluid Lend referral entry and its capital-productivity boundary.
